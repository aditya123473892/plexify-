...
const BankAccountManagement = () => {
  ...
  const [formData, setFormData] = useState({
    account_holder: "", // Matches backend field
    account_number: "", // Matches backend field
    bank_name: "", // Matches backend field
    account_type: "", // Matches backend field
    balance: "", // Matches backend field
    notes: "", // Matches backend field
  });
    ...
    try {
      if (editIndex !== null) {
        ...
        await axios.put(
          ...
          {
            ...formData,
            balance: parseFloat(formData.balance), // Ensure numeric type for balance
          },
          { headers: { Authorization: `Bearer ${token}` } }
        );
