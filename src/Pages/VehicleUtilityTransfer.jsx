...
const VehicleUtilityTransfer = () => {
  const [transfers, setTransfers] = useState([{ vehicleId: '', vehicleModel: '', newOwner: '', transferDate: '' }]);
  ...
  const addTransfer = () => {
    setTransfers([...transfers, { vehicleId: '', vehicleModel: '', newOwner: '', transferDate: '' }]);
  };
  ...
  return (
    <div className="min-h-screen shadow-2xl bg-white p-6 rounded-lg md:mt-10 mt-20">
      <header className="mb-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">Vehicle Utility Transfer</h1>
        <p className="text-gray-600">
          Submit the details for transferring the utility rights of your vehicle.
        </p>
      </header>
      ...
      <FieldSection title="Transfer Details">
            <InputWithIcon
              ...
              onChange={(e) => handleTransferChange(index, 'vehicleId', e.target.value)}
            />
            <InputWithIcon
              icon={<FaTrash className="text-[#538d2dfd] mx-2" />}
              type="text"
              ...
              onChange={(e) => handleTransferChange(index, 'vehicleModel', e.target.value)}
            />
            <InputWithIcon
              icon={<FaTrash className="text-[#538d2dfd] mx-2" />}
              type="text"
              ...
              onChange={(e) => handleTransferChange(index, 'newOwner', e.target.value)}
            />
            <InputWithIcon
              icon={<FaTrash className="text-[#538d2dfd] mx-2" />}
              type="date"
              ...
              onChange={(e) => handleTransferChange(index, 'transferDate', e.target.value)}
            />
            <button
